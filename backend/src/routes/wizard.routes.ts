 ...
 */
router.post('/:id/documents', WizardController.uploadDocument);
 ...
 * Body: { url: string }
 */
router.post('/:id/scrape-linkedin', WizardController.scrapeLinkedIn);

/**
 * POST /api/wizard/:id/profile-draft
 * Draft step-2 profile fields using uploaded supporting docs
 */
router.post('/:id/profile-draft', WizardController.draftProfileFromDocuments);
