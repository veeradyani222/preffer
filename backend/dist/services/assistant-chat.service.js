...
- Return plain text only`;
    ...
    static buildPortfolioContext(portfolio) {
        ...
        const currentColor = ((_a = portfolio.color_scheme) === null || _a === void 0 ? void 0 : _a.name)
            || ((_c = (_b = portfolio.wizard_data) === null || _b === void 0 ? void 0 : _b.colorScheme) === null || _c === void 0 ? void 0 : _c.name)
            || ((_e = (_d = portfolio.wizard_data) === null || _d === void 0 ? void 0 : _d.color_scheme) === null || _e === void 0 ? void 0 : _e.name)
            || 'default';
        return {
