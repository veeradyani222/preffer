...
const ai_capability_service_1 = require("./ai-capability.service");
...
function buildCapabilityPolicy(portfolio) {
    ...
    const enabledConfigs = enabledKeys.map((key) => {
        ...
        return ({
            capability_key: key,
            enabled: true,
            settings_json: ((_a = capabilityConfig[key]) === null || _a === void 0 ? void 0 : _a.settings) || ((_b = capabilityConfig[key]) === null || _b === void 0 ? void 0 : _b.settings_json) || {},
        });
    });
    ...
    lines.push('Readiness requirements by capability:');
    lines.push(ai_capability_service_1.AICapabilityService.buildCapabilityReadinessGuidance(enabledConfigs));
    return `${lines.join('\n')}\n${baseRules.join('\n')}`;
}
