...
exports.resolvePortfolioColorScheme = resolvePortfolioColorScheme;
const database_1 = __importDefault(require("../config/database"));
const credits_service_1 = require("./credits.service");
function resolvePortfolioColorScheme(row) {
    var _a, _b;
    return (row === null || row === void 0 ? void 0 : row.color_scheme)
        || ((_a = row === null || row === void 0 ? void 0 : row.wizard_data) === null || _a === void 0 ? void 0 : _a.colorScheme)
        || ((_b = row === null || row === void 0 ? void 0 : row.wizard_data) === null || _b === void 0 ? void 0 : _b.color_scheme)
        || null;
}
// ============================================
// PORTFOLIO SERVICE
...
class PortfolioService {
    ...
    static async publish(portfolioId, userId, slug, hasAiManager) {
        ...
        try {
            ...
            const colorScheme = resolvePortfolioColorScheme(portfolio);
    ...
    static formatPortfolio(row) {
        return {
            ...
            theme: row.theme,
            color_scheme: resolvePortfolioColorScheme(row),
